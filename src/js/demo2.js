...
const lines = [];
let linesMaterials = [
  new THREE.LineBasicMaterial({ transparent: true, color: 0x9C2E35 }),
  new THREE.LineBasicMaterial({ transparent: true, color: 0x964B00 }),
  new THREE.LineBasicMaterial({ transparent: true, color: 0xE25822 }),
  new THREE.LineBasicMaterial({ transparent: true, color: 0xB2BBC6 }),
  new THREE.LineBasicMaterial({ transparent: true, color: 0xd4f1f9 }),

];
let galaxyColors = [
  new THREE.Color("#e25822").multiplyScalar(0.8),
  new THREE.Color("#b2bbc6").multiplyScalar(0.8),
  new THREE.Color("#70483c").multiplyScalar(0.8),
  new THREE.Color("#a6e7ff").multiplyScalar(0.8),
  new THREE.Color("#d4f1f9").multiplyScalar(0.8)
];
function dots() {
